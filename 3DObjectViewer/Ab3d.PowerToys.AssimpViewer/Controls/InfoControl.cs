...
namespace ThreeDObjectViewer.Controls
{
  ...
  // </Grid>
        ...
        public InfoControl()
        {
            ...
            this.Loaded += new RoutedEventHandler(InfoControl_Loaded);            
        }

        void InfoControl_Loaded(object sender, RoutedEventArgs e)
        {
        ...
        private void EnsureInfoIcon()
        {
            ...
            if (_infoIcon == null)
            {
                ...
                _infoIcon.BeginInit();
                _infoIcon.StreamSource = Application.GetResourceStream(new Uri("Resources/info_icon.png", UriKind.Relative)).Stream;
                _infoIcon.EndInit();
            }
        }
    }
